...
function Toggle({ checked, onChange }) {
  return (
    <button
      ...
      className={`relative h-6 w-11 shrink-0 rounded-full transition-colors ${checked ? 'bg-accent-600' : 'bg-slate-200'}`}
    >
      <span
      ...
      <form onSubmit={handleSave} className="space-y-6">
        <section className="rounded-2xl border border-slate-200 bg-white p-5 sm:p-6 shadow-sm">
          <div className="mb-5 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-slate-500">{t('settings.profileSubtitle')}</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div>
              ...
              <input
                ...
                className="w-full rounded-lg border border-slate-200 bg-slate-50 py-2.5 px-3 text-sm text-slate-700 outline-none transition-colors focus:border-accent-400 focus:bg-white focus:ring-2 focus:ring-accent-100"
              />
            </div>
            <div>
            ...
            <div>
              ...
              <input
                type="text"
                defaultValue={currentUser.role[lang]}
                className="w-full rounded-lg border border-slate-200 bg-slate-50 py-2.5 px-3 text-sm text-slate-700 outline-none transition-colors focus:border-accent-400 focus:bg-white focus:ring-2 focus:ring-accent-100"
              />
            </div>
            <div>
              <label className="mb-1.5 block text-sm font-medium text-slate-700">{t('settings.company')}</label>
              <input
                type="text"
                defaultValue={currentUser.company[lang]}
                className="w-full rounded-lg border border-slate-200 bg-slate-50 py-2.5 px-3 text-sm text-slate-700 outline-none transition-colors focus:border-accent-400 focus:bg-white focus:ring-2 focus:ring-accent-100"
              />
            </div>
          </div>
        ...
        <section className="rounded-2xl border border-slate-200 bg-white p-5 sm:p-6 shadow-sm">
          <div className="mb-5 flex items-center gap-3">
            ...
            <div>
              <h2 className="text-base font-semibold text-slate-900">{t('settings.preferences')}</h2>
              <p className="text-sm text-slate-500">{t('settings.preferencesSubtitle')}</p>
            </div>
          </div>
          ...
          <div className="space-y-5">
            ...
            <div className="flex items-center justify-between border-t border-slate-100 pt-5">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <p className="text-sm font-medium text-slate-700">{t('settings.emailNotifications')}</p>
            ...
            <div className="flex items-center justify-between border-t border-slate-100 pt-5">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <p className="text-sm font-medium text-slate-700">{t('settings.darkMode')}</p>
