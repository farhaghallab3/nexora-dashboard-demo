...
export default function Login() {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-slate-50 px-4 py-12">
      <div className="pointer-events-none absolute -top-32 start-1/2 h-96 w-96 -translate-x-1/2 rounded-full bg-accent-200/40 blur-3xl" />
      ...
      <div className="relative w-full max-w-sm animate-fade-in">
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-6 sm:p-8 shadow-sm">
          <h2 className="text-lg font-semibold text-slate-900">{t('login.welcome')}</h2>
          <p className="text-sm text-slate-500 mt-1 mb-6">{t('login.subtitle')}</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full rounded-lg border border-slate-200 bg-slate-50 py-2.5 ps-9 pe-3 text-sm text-slate-700 placeholder:text-slate-400 outline-none transition-colors focus:border-accent-400 focus:bg-white focus:ring-2 focus:ring-accent-100"
                />
              </div>
            </div>
            ...
            <div className="flex items-center justify-between text-sm">
              <label className="flex items-center gap-2 text-slate-600">
                <input type="checkbox" className="h-4 w-4 rounded border-slate-300 text-accent-600 focus:ring-accent-400" />
                {t('login.rememberMe')}
              </label>
          ...
          <div className="mt-5 flex items-start gap-2 rounded-lg bg-accent-50 p-3 text-xs text-accent-700">
        ...
        <p className="mt-6 text-center text-sm text-slate-500">
          {t('login.noAccount')}{' '}
          <button className="font-medium text-accent-600 hover:text-accent-700">{t('login.signUp')}</button>
        </p>
      </div>
    </div>
  )
